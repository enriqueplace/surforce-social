...
class Registracion_RegistracionController extends Zend_Controller_Action
{
    public function init()
    {
        ...
        /**
         * definidicion de propiedades para el modelo vista.
         * esta parte es propia para cada proyecto.
         */
    ...
    public function addAction()
    {
	    ...
	    $month 		= 	'';
	    $year 		= 	'';
		$this->view->zonas = $this->getRegion();
    ...
    /**
     * getRegion() devuelve un array con los paises del mundo,
     * 				lo abstrae desde la db,
     *  			podría sacarlo de un xml??
     * 
