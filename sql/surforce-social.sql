...
INSERT INTO `menu` (`idMenu`, `idCategoriaMenu`, `item`, `destino`, `posicion`, `privado`, `estado`) VALUES
...
CREATE TABLE IF NOT EXISTS `menus` (
  ...
  `privado` char(1) collate utf8_spanish_ci NOT NULL,
...
INSERT INTO `noticias` (`idNoticia`, `titulo`, `contenido`, `fecha`, `id_usuario`) VALUES
...
INSERT INTO `zonas` (`idZona`, `idPadre`, `nombre`, `estado`) VALUES
(1, 0, 'Algeria', 1),
(2, 0, 'Angola', 1),
(3, 0, 'Benin', 1),
(4, 0, 'Botswana', 1),
